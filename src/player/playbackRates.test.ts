...
describe('playback rate policy', () => {
  it('owns the VistaPlay standard rate ladder through 4x', () => {
    expect(VISTAPLAY_STANDARD_RATES).toEqual([0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4])
  })
  ...
  it('resolves temporary boost from actual supported rates', () => {
    ...
    expect(nextSupportedRate(1.5, [1, 1.5, 2, 4], 'maximum')).toBe(4)
  })
})
