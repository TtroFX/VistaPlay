...
export default function StatisticsPage() {
  ...
  const stats = useMemo(() => calculateStatistics(sessions, Object.fromEntries(Object.values(app.state.videos).map((v) => [v.videoId, v.durationSeconds ?? 0]))), [sessions, app.state.videos])
